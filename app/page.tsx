                    ...
                    <ul role="list" className="flex flex-1 flex-col">
                      <li>
                        <ul role="list" className="space-y-1">
                          ...
                          <li>
                            <button className="bg-gray-50 text-violet-600 group flex w-full gap-x-3 whitespace-nowrap rounded-md p-2 text-sm font-semibold  leading-6">
                              <svg
                                viewBox="13.38 3.2 485.44 505.7"
                                xmlns="http://www.w3.org/2000/svg"
                                className="fill-violet-600 text-violet-600 h-6 w-6 shrink-0"
                                fill="white"
                              >
              ...
              <div className="flex flex-col align-top lg:flex-row lg:space-x-8 lg:align-middle">
                ...
                <div className="m-auto w-full lg:my-0 lg:w-2/6">
                  <div className="  rounded border p-4">
                    ...
                    <button
                      data-variant="flat"
                      className="mt-4 w-full bg-slate-800 text-slate-50 py-3 rounded-lg hover:bg-slate-900 hover:text-white"
                      type="submit"
                    >
                      Create Chatbot
                    </button>
