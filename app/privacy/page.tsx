    ...
    <div className="py-16 sm:py-24">
      <div className="prose mx-auto max-w-7xl">
        ...
        <p>
          ...
          for your use only on the condition that you agree to the Terms of
          Service available under the following address:
          <a href="https://chatbase-plum.vercel.app/terms">
            https://chatbase-plum.vercel.app/terms
          </a>{" "}
          (“Terms of Service”) which include the terms of the Privacy Policy set
          forth below. Chatbase.co (“Company”) operates the Service.We use your
        ...
        <p>
          ...
          delete, or limit the use of your Personal Data. You have the following
          data protection rights:
        </p>
        <ol type="a">
          <li>
            to access to your Personal Data by requesting sharing and/or sending
            a copy of all your Personal Data processed by us;
          </li>
          <li>
          ...
          <li>
            ...
            refuse to erase the Personal Data in specific circumstances provided
            by law;
          </li>
          <li>
          ...
          <li>
            ...
            Personal Data after withdrawal your consent if we have the legal
            basis for such processing, for the purposes defined by that legal
            basis;
          </li>
          <li>
        ...
        <p>
          ...
          with the processing of payments or where there is another legal basis.
          You may withdraw your consent to our processing of your Personal Data
          by contacting us as indicated in the “How to Contact Us” section of
          the Privacy Policy. If you withdraw your consent for us to process
          your Personal Data for one of the primary purposes indicated above,
          then in some situations we may not be able to provide the service,
          though we may still engage in certain processing authorized by law.
          The Company may also use data and related data analysis in other
        ...
        <p>
          ...
          sharing by contacting us as indicated in the “How to Contact Us”
          section of the Privacy Policy. We also share the related information
          we obtain with our customers, partners, affiliates, and joint
          marketing partners. These entities, which collectively are referred to
          here as the “Business Partners” may use the information for the
          purposes described in this Privacy Policy. We may also share the
          information with our Business Partners and other third parties for
          warranty, troubleshooting or maintenance purposes, or for improving
          the design and performance of their products and services.
        </p>
        <p>
        ...
        <p>
          ...
          before deleting it. We will answer your requests to access, correct or
          cancel your Personal Data or to object or withdraw your consent to our
          processing of your Personal Data within 20 business days from the date
          we receive your complete request or as provided by law. To be
          considered complete, your request must include your full name and
          contact address, and a clear and detailed description of your request.
        </p>
        <p>
        ...
        <p>
          ...
          Act on the Protection of Personal Information. The Company is
          primarily responsible for the management of the Personal Data that is
          jointly used with our affiliates or third parties. We will not provide
          your information to third parties for marketing purposes without your
          prior consent.
        </p>
        <p>
        ...
        <p>
          ...
          or her consent for our use of the information, (ii) the purpose of our
          ...
          handling of Personal Data with respect to services provided in
          Republic of Korea.
        </p>
      </div>
    </div>
